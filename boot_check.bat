@echo off
REM Boot check generique crispz-krea (remplace les anciens scripts rtx5090).
REM
...
echo [4/5] diffusers...
!RUNPY! -c "from diffusers import FluxPipeline, FluxImg2ImgPipeline, FluxInpaintPipeline; print('    FLUX.1 pipelines OK')" 2>nul
if errorlevel 1 echo    [ATTENTION] FLUX.1 pipelines indisponibles -^> lance install.bat / update.bat.
echo.
...
if defined EXPOSE (
    ...
    echo  crispz-krea n'a AUCUNE authentification et sert ton dossier de
...
echo ====================================================
echo    Checks OK. Lancement de crispz-krea...
echo ====================================================
