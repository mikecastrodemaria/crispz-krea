...
def _expand_spec(spec, seed):
    ...
    # cz_prompt n'a pas de strip_lora_tags ici: on retire les tags du negatif
    # avec la regex du protocole (jamais envoyes a l'encodeur de texte).
    if negative and _LORA_TAG.search(negative):
        negative = re.sub(r"\s{2,}", " ", _LORA_TAG.sub(" ", negative))
