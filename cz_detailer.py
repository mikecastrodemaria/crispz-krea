"""crispz-krea - auto face detailer (facon ADetailer / Fooocus "Enhance").
...
Swap) et repasse CHAQUE visage en img2img a haute resolution :
  crop elargi (+60%) -> agrandi au sweet spot du modele (~832 px) -> refine FLUX
...
_TARGET = 832      # cote de travail du crop (sweet spot FLUX, /32)
